  ...
  return (
    <section className="py-24 bg-card">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Built for fitness influencers</h2>
          <p className="text-muted-foreground text-lg">Create, sell, and deliver a course in one place.</p>
        </motion.div>
        ...
        <p className="text-center text-muted-foreground text-sm mt-8">Included with every plan</p>
      </div>
    </section>
  );
};
